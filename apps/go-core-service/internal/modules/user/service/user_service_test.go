...
// 	searchUsersFn      func(ctx context.Context, name string, email string, phone string) ([]*entity.User, error)
// }
...
// func (m *mockUserRepository) SearchUsers(ctx context.Context, name string, email string, phone string) ([]*entity.User, error) {
// 	if m.searchUsersFn != nil {
// 		return m.searchUsersFn(ctx, name, email, phone)
// 	}
// 	return nil, nil
// }
