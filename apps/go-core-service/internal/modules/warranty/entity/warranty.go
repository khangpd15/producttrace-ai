...
type Warranty struct {
	...
	ItemCode          string         `json:"itemCode" gorm:"column:item_code;type:varchar;not null"`
	ItemName          string         `json:"itemName" gorm:"column:item_name;type:varchar"`
	SerialNumber      string         `json:"serialNumber" gorm:"column:serial_number;type:varchar;not null"`
	...
	Status            WarrantyStatus `json:"status" gorm:"column:status;type:varchar;default:ACTIVE"`
