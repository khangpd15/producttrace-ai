...
// 	err     error
// }
// func (m *mockOwnership) VerifyOwnership(ctx context.Context, userID uuid.UUID, productItemID uuid.UUID) (bool, error) {
// 	return userID == m.ownerID && m.err == nil, m.err
// }
// func (m *mockOwnership) GetActiveOwner(ctx context.Context, productItemID uuid.UUID) (uuid.UUID, error) {
// 	if m.err != nil {
...
// 		&mockOwnership{ownerID: testUser},
...
// 	resp, err := svc.CreateWarrantyClaim(context.Background(), testUser, dto.CreateWarrantyClaimRequest{
// 		ProductID: uuid.New(),
...
// 	svc := service.NewWarrantyClaimService(
// 		&mockRepo{claim: nil},
// 		&mockOwnership{ownerID: uuid.Nil}, // Fails here (not registered)
// 		&mockProduct{isValid: true},
// 		&mockEvent{},
// 		&mockAudit{},
// 		&mockNotification{},
...
// 	if !errors.Is(err, service.ErrOwnershipValidation) {
...
// 	svc := service.NewWarrantyClaimService(
// 		&mockRepo{claim: nil},
// 		&mockOwnership{ownerID: testUser}, // Passes
...
// 	_, err := svc.CreateWarrantyClaim(context.Background(), testUser, dto.CreateWarrantyClaimRequest{
// 		ProductID: uuid.New(),
// 	})

// 	if !errors.Is(err, service.ErrWarrantyExpired) {
...
// 	if !errors.Is(err, service.ErrClaimAlreadyOpen) {
